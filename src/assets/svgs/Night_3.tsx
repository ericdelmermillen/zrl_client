...
const Night_3: FC<ClassNameInterface> = ({ className }) => {
  return (
    <>
       <svg
          className={className}
        ...
        >
          <style>{`
            .fill-yellow { fill: #EFC75E; }
            .fill-dark-yellow { fill: #C89147; }
            .fill-light-yellow { fill: #D7B354; }
            .fill-gold { fill: #DFA14F; }
          `}</style>
          ...
          <g>
            ...
            <g>
              ...
              />
              <circle className="fill-gold" cx="183.729" cy="183.724" r="26.261" />
              <path
                className="fill-gold"
                ...
                z"
              />
              <circle className="fill-gold" cx="96.238" cy="201.331" r="17.502" />
            </g>
          </g>
        </svg>
