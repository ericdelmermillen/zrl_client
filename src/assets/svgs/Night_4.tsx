    ...
    <>
      ...
      >
        <style>{`
          ...
          .fill2 { fill: #EBE9D2; }
          .fill3 { fill: #D4D5B1; }
          .fill4 { fill: #040000; opacity: 0.06; }
          .fill5 { opacity: 0.5; fill: #FFFFFF; }
          .fill6 { opacity: 0.1; fill: #040000; }
        `}</style>
        ...
        <g>
          <g>
            <path
              className="fill1"
              d="M90.822,60.408c105.574-92.296,264.984-76,357.28,29.574s84.138,262.286-21.436,354.583
              S158.688,529.26,66.392,423.687S-14.752,152.704,90.822,60.408z"
            />
            <path
              className="fill2"
              d="M107.702,89.331c99.918-87.352,248.823-74.176,333.823,23.051s75.389,243.385-24.528,330.736
              c-99.918,87.352-251.733,82.319-336.733-14.909S7.784,176.683,107.702,89.331z"
            />
            <g>
              <path
                className="fill3"
                d="M244.034,141.578C226.114,178.849,181.001,192.92,143.73,175
              ...
              <path
                className="fill4"
                d="M128.089,97.737c17.92-37.271,62.836-54.047,100.107-36.127
            ...
            <path
              className="fill3"
              d="M217.126,218.456c-1.17-5.733,2.71-11.178,8.442-12.348c5.733-1.17,11.248,2.359,12.418,8.092
              s-2.456,11.466-8.189,12.636C224.065,228.005,218.296,224.189,217.126,218.456z"
            />
            <path
              className="fill5"
              d="M363.159,97.031c-1.17-5.733,2.71-11.178,8.442-12.348s11.248,2.359,12.418,8.092
              c1.17,5.733-2.456,11.466-8.189,12.636C370.097,106.581,364.328,102.764,363.159,97.031z"
            />
            <path
              className="fill3"
              d="M282.758,398.482c8.691-7.598,21.813-6.256,29.411,2.434c7.598,8.691,6.926,21.591-1.765,29.189
              c-8.691,7.598-22.06,6.972-29.658-1.719C273.149,419.697,274.067,406.08,282.758,398.482z"
            />
            <path
              className="fill5"
              d="M58.328,221.051c-1.17-5.733,2.71-11.178,8.442-12.348
              c5.733-1.17,11.248,2.359,12.418,8.092c1.17,5.733-2.456,11.466-8.189,12.636C65.267,230.6,59.498,226.784,58.328,221.051z"
            />
            <path
              className="fill3"
              d="M468.957,281.792c-3.725,36.65-37.257,62.1-73.907,58.374c-36.65-3.725-63.179-35.28-59.453-71.93
              c3.725-36.65,36.273-64.306,72.923-60.581C445.17,211.381,472.683,245.142,468.957,281.792z"
            />
            <g>
              <path
                className="fill3"
                d="M173.243,331.228c14.631,25.328,4.867,57.296-20.461,71.927
              ...
              <path
                className="fill4"
                d="M112.82,324.421c18.464-10.666,41.211-8.787,57.856,2.82
            ...
            <path
              className="fill4"
              d="M349.708,282.184c3.725-36.65,36.272-64.306,72.923-60.581
          ...
          <path
            className="fill6"
            d="M254.816,381.8c-105.36,0-198.423-52.065-254.726-131.657
